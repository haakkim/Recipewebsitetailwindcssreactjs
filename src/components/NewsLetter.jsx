      ...
      <div className='mx-auto grid lg:grid-cols-3 '>
        ...
        <div className='my-4'>
          <div className='flex flex-col sm:flex-row items-center justify-between w-full'>
            ...
            <button className='bg-[#00df9a] text-white rounded-md font-medium w-[200px] ml-4 my-8 px-6 py-3  border-none'>
              Notify me
            </button>
          </div>
          <p>we are connnected about the security of your data, Read{""} 
          <span className='bg-[#00df9a]'> Privacy Policy
